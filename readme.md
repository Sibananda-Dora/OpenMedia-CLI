# DON'T USE IT YET, YOU CAN CHECK THE CODEBASE BUT IT IS NOT MY PROBLEM IF YOUR MODEL HALLUCINATES (AS IT IS A CLI RUNNING IN A SHELL). WAIT TILL I ADD MORE SECURITY LOGIC.
